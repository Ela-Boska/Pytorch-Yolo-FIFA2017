...
# Training settings
    ...
    def train(epoch):
        ...
        if (epoch + 1) % save_interval == 0:
            ...
            logging('save weights to '+cfgfile.replace('.cfg',str(epoch+1)+'.weights'))
            cur_model.seen = (epoch + 1) * len(train_loader.dataset)
            cur_model.save_weights(cfgfile.replace('.cfg',str(epoch+1)+'.weights'))
    ...
    def test(epoch):
        ...
        print ('{} correct'.format(correct),'{} proposed'.format(proposals),'{} true'.format(total))
