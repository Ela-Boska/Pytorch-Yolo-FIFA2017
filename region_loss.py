...
class RegionLoss(nn.Module):
    ...
    def forward(self, output, target):
        ...
        x = torch.sigmoid(output.index_select(2, Variable(
            torch.cuda.LongTensor([0]))).view(nB, nA, nH, nW))
        y = torch.sigmoid(output.index_select(2, Variable(
        ...
        conf = torch.sigmoid(output.index_select(2, Variable(
        ...
        tcls = Variable(tcls_temp.long().cuda())
